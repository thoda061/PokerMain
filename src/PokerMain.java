...
public class PokerMain {
   ...
   private static final String PATTERN ="(([1-9]|([1][0-3])|[KQJAkqja])[sdhcSDHC][\\/\\s\\-])(([1-9]|([1][0-3])|[KQJAkqja])[sdhcSDHC][\\/\\s\\-])(([1-9]|([1][0-3])|[KQJAkqja])[sdhcSDHC][\\/\\s\\-])(([1-9]|([1][0-3])|[KQJAkqja])[sdhcSDHC][\\/\\s\\-])(([1-9]|([1][0-3])|[KQJAkqja])[sdhcSDHC])";
	
	/**
	 * Reads in line, determines whether it match regex, if it does separates cards
